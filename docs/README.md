...
Este directorio conserva las decisiones y contratos que deben mantenerse coordinados entre los siete microservicios.

- [Arquitectura](architecture/README.md): límites, servicios y propiedad de datos.
- [Mapa de integraciones](architecture/context-map.md): dependencias entre contextos.
